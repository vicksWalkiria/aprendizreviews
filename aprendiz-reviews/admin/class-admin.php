...
class Aprendiz_Reviews_Admin
{
    ...
    public function add_plugin_admin_menu()
    {
        // Menú principal
        add_menu_page(
            __('Aprendiz Reviews', 'aprendiz-reviews'),
            __('Aprendiz Reviews', 'aprendiz-reviews'),
            'manage_options',
            'aprendiz-reviews',
        ...
        add_submenu_page(
            'aprendiz-reviews',
            __('Añadir Producto', 'aprendiz-reviews'),
            __('Añadir Producto', 'aprendiz-reviews'),
            'manage_options',
            'añadir-producto',
        ...
        add_submenu_page(
            'aprendiz-reviews',
            __('Gestionar Reseñas', 'aprendiz-reviews'),
            __('Gestionar Reseñas', 'aprendiz-reviews'),
            'manage_options',
            'gestionar-resenas',
        ...
        add_submenu_page(
            'aprendiz-reviews',
            __('Añadir Reseña', 'aprendiz-reviews'),
            __('Añadir Reseña', 'aprendiz-reviews'),
            'manage_options',
            'añadir-resena',
        ...
        add_submenu_page(
            'aprendiz-reviews',
            __('Importar de WooCommerce', 'aprendiz-reviews'),
            '🛒 ' . __('Importar WooCommerce', 'aprendiz-reviews'),
            'manage_options',
        ...
        add_submenu_page(
            'aprendiz-reviews',
            __('Insertar Automáticamente', 'aprendiz-reviews'),
            '🎯 ' . __('Auto-Insertar', 'aprendiz-reviews'),
            'manage_options',
            'auto-shortcode',
